...
# We ignore DATABASE_URL to prevent old PostgreSQL variables in Render from breaking the app.
MONGODB_URI = os.environ.get(
    "MONGODB_URI", 
    "mongodb+srv://sabatsambit49_db_user:RG9yd1386iRzaPx8@cluster0.tljkviw.mongodb.net/?appName=Cluster0"
)
